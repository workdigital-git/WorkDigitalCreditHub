...
export default function AuthPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: "Account created!", description: "Welcome to Credits Hub." });
      setLocation("/dashboard");
    } catch (error) {
      toast({
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-semibold" data-testid="text-auth-title">
            Membership & Credits Hub
          </CardTitle>
          <CardDescription>
            Your central platform for managing credits across all apps
          </CardDescription>
        </CardHeader>
        <CardContent>
